...
fn dispatch_inner(args: SyscallArgs) -> SyscallResult {
    ...
    match lookup(args.number) {
        ...
        Some(BsdSyscall::Getuid) => process::handle_getuid(),
        Some(BsdSyscall::Geteuid) => process::handle_geteuid(),
        Some(BsdSyscall::Getgid) => process::handle_getgid(),
        Some(BsdSyscall::Getegid) => process::handle_getegid(),
        ...
        Some(BsdSyscall::Readv) => io::handle_readv(args),
        Some(BsdSyscall::Writev) => io::handle_writev(args),
        ...
        Some(BsdSyscall::Chdir) => fs::handle_chdir(args),
        ...
        Some(BsdSyscall::Socketpair) => net::handle_socketpair(args),
        ...
        Some(BsdSyscall::Sendmsg) => net::handle_sendmsg(args),
        Some(BsdSyscall::Recvmsg) => net::handle_recvmsg(args),
        Some(BsdSyscall::Poll) => net::handle_poll(args),
        Some(BsdSyscall::Kevent) => net::handle_kevent(args),
